$(document).ready(function()
  ...
  $('a[rename]').click(function (e) {
    ...
    name = $(this).attr('name');
    row = 'tr#' + id + ' a.name'; 
    $(row).replaceWith('<form action="news.php" method="post" id="rename"><input type="text" id="rename" name="rename" value="' + name +'"/><input type="hidden" id="id" name="id" value="' + id +'" /><input type="submit" name="submit" value="Rename" /></form>');
    });
  ...
  $('textarea#post_content').ckeditor(function() { }, {
